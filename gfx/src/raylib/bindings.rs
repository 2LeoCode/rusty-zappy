...
pub const RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCE_TX: u32 = 9;
...
unsafe extern "C" {
  pub fn GetFileExtension(fileName: *const ::std::os::raw::c_char)
...
unsafe extern "C" {
  pub fn GetDirectoryPath(filePath: *const ::std::os::raw::c_char)
  -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn IsGamepadButtonDown(gamepad: ::std::os::raw::c_int, button: ::std::os::raw::c_int)
  -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn GetGamepadAxisMovement(gamepad: ::std::os::raw::c_int, axis: ::std::os::raw::c_int)
  -> f32;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn GetSplinePointBasis(p1: Vector2, p2: Vector2, p3: Vector2, p4: Vector2, t: f32)
  -> Vector2;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn CheckCollisionPointTriangle(point: Vector2, p1: Vector2, p2: Vector2, p3: Vector2)
  -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn GetPixelColor(srcPtr: *mut ::std::os::raw::c_void, format: ::std::os::raw::c_int)
  -> Color;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn UnloadTextLines(text: *mut *mut ::std::os::raw::c_char, lineCount: ::std::os::raw::c_int);
}
unsafe extern "C" {
  pub fn TextCopy(
...
const _: () = {
  ...
  ["Offset of field: rlRenderBatch::draws"][::std::mem::offset_of!(rlRenderBatch, draws) - 16usize];
...
pub const rlGlVersion_RL_OPENGL_11_SOFTWARE: rlGlVersion = 0;
...
unsafe extern "C" {
  pub fn rlGetProcAddress(procName: *const ::std::os::raw::c_char) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
...
unsafe extern "C" {
  pub fn rlSetVertexAttributeDivisor(index: ::std::os::raw::c_uint, divisor: ::std::os::raw::c_int);
}
unsafe extern "C" {
